...
public class AdventOfCodeDay22Test {
    ...
    public void solveAocPuzzle_firstPart_example() {
        int result = new AdventOfCodeDay22(inputLinesExample).solveFirstPart();
        assertEquals("firstPart example", 1, result);
    }

    @Test
    public void solveAocPuzzle_firstPart_myPuzzleInput() {
        List<String> inputLines = readAllLinesOfClassPathResource("/puzzleInputDay22.txt");
        int result = new AdventOfCodeDay22(inputLines).solveFirstPart();
        assertEquals("firstPart myPuzzleInput", 1, result);
    }

    @Test
    public void solveAocPuzzle_secondPart_example() {
        int result = new AdventOfCodeDay22(inputLinesExample).solveSecondPart();
    ...
    public void solveAocPuzzle_secondPart_myPuzzleInput() {
        List<String> inputLines = readAllLinesOfClassPathResource("/puzzleInputDay22.txt");
        int result = new AdventOfCodeDay22(inputLines).solveSecondPart();
