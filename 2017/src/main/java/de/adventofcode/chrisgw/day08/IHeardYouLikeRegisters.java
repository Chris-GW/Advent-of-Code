...
public class IHeardYouLikeRegisters {
    ...
    public List<CpuRegisterInstruction> parseCpuRegisterInstructions(List<String> cpuRegisterInstructionLines) {
        return cpu.parseCpuRegisterInstructions(cpuRegisterInstructionLines);
    }

    public CpuRegisterInstruction parseCpuRegisterInstruction(String cpuRegisterInsturctionStr) {
        return cpu.parseCpuRegisterInstruction(cpuRegisterInsturctionStr);
    }


    public CpuRegister findCpuRegister(String registerName) {
        return cpu.findCpuRegister(registerName);
    }


    public int findLargestCpuRegisterValue() {
        return cpu.findLargestCpuRegisterValue();
    }

    public int findLargestCpuRegisterValueHeld() {
        return cpu.findLargestCpuRegisterValueHeld();
    }
